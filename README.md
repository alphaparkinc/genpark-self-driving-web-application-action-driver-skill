# genpark-self-driving-web-application-action-driver-skill
...
> **GenPark AI Agent Skill** -- Self-driving web application action driver & headless browser agent (Coldtea style)
